...
const Spinner = class {
    ...
    render() {
        return (index.h(index.Host, { key: '23e62d55359b0a01622678db119254b629fe0534' }, index.h("div", { key: 'ce8e610e2aa2669840151fa9e6520719cc721d55', class: "lds-ring" }, index.h("div", { key: 'e08cc0f371ddb1a496eb12afb3efeb7c6b50a652' }), index.h("div", { key: 'df4068bf815e2b035dff677ae716e6e3a72b8115' }), index.h("div", { key: '4785d38af3b77ade0b9cdb99bf0f82f72bd4bf76' }), index.h("div", { key: 'abe26581838cd6abc1217bbe0bc76762bed519ac' }))));
    }
};
...
const StockFinder = class {
    ...
    render() {
        let content = (index.h("ul", { key: '49fc1e3d388693dce911d709b4c0902680868388' }, ' ', this.searchResults.map(result => (index.h("li", { onClick: this.onSelectSymbol.bind(this, result.symbol) }, index.h("strong", null, result.symbol), " - ", result.name)))));
        if (this.loading) {
            content = index.h("uc-spinner", { key: '9e15f9f35f9724b4b1c8a67c6fe3fc81f637842a' });
        }
        return [
            index.h("form", { onSubmit: this.onfindStocks.bind(this), key: 'form' }, index.h("input", { key: 'fcdb2f0756ac753711d3c00bb343ede84b4131c2', id: "stock-symbol", ref: el => (this.stockNameInput = el) }), index.h("button", { key: '451ea426fec49f0e2d924a35998382da680f3863', type: "submit" }, "Find!")),
            content,
        ];
    }
};
...
const StockPrice = class {
    ...
    //   }
    render() {
        let dataContent = index.h("p", { key: '5289390e82c513b78772cae6a87225791494b2d2' }, "Please enter a symbol");
        if (this.error) {
            dataContent = index.h("p", { key: 'f6c1ef22a6fd3c8668129d2267265277dc0eacf5' }, this.error);
        }
        if (this.fetchedPrice) {
            dataContent = index.h("p", { key: 'e57edb96b19cf463ec8f99cfe5d9a067880fff4f' }, "Price: $", this.fetchedPrice);
        }
        if (this.loading) {
            dataContent = index.h("uc-spinner", { key: 'da4876640749b8f108a0875f49e75d09236aadfa' });
        }
        return (index.h(index.Host, { key: '20dfa2d163c813c96a30448b431167475235b71e', class: this.error ? 'error' : '' }, index.h("form", { onSubmit: this.onFetchStockPrice.bind(this), key: 'form' }, index.h("input", { key: '13f1e957a8a8a595e780cea3ee95b14f5ab7752c', id: "stock-symbol", ref: el => (this.stockInput = el), value: this.stockUserInput, onInput: this.onUserInput.bind(this) }), index.h("button", { key: '4fea39dc57f6d6c769a331c22e5730b1dc4ec038', type: "submit", disabled: !this.stockInputValid || this.loading }, "Fetch")), index.h("div", { key: "divKey" }, dataContent)));
    }
...
//# sourceMappingURL=uc-spinner_3.cjs.entry.js.map